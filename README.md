...
Mi idea de proyecto de fin de grado es realiar una aplicación llamada "FindPlayGround", se llamará así porque mi idea es hacer una especie de red social donde tiendas y jugadores de juegos de mesa tengan un portal donde comunicarse con otros jugadores y saber donde hay tiendas cerca de su zona. 

En las cuentas de los jugadores podrás poner que juegos de mesas juegas, cuáles son tus gustos y podrás poner posts y cosas para darse a conocer y quedar con otros jugadores de los mismos gustos o que juegue las mismas cosas en una tienda cercana y echarse unas partidas.
